...
import { BookOpen, Home, Calculator, BookMarked, Menu, X, TrendingUp, ShieldCheck, Gamepad2, ChevronRight } from 'lucide-react';
...
const Navigation: React.FC<NavigationProps> = ({ currentView, setView }) => {
  ...
  { id: ViewState.AI_TUTOR, label: 'Tutor', icon: BookMarked },
  ];
